    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-red-50 py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center font-bold transition ${
                    step === s
                      ...
                      : ['service', 'date', 'time', 'contact', 'confirmation']
                          .indexOf(step) > index
        ...
        {step === 'time' && selectedService && (
          <div className="bg-white rounded-lg p-8 border border-gray-200">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">
              Selecciona una hora para {parseLocalDateString(selectedDate).toLocaleDateString('es-ES', {
                weekday: 'long',
                year: 'numeric',
                month: 'long',
                day: 'numeric',
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="bg-pink-50 border border-pink-200 rounded-lg p-4 mt-6">
                ...
                <ul className="text-sm text-gray-700 space-y-1">
                  ...
                  <li><strong>Fecha:</strong> {parseLocalDateString(selectedDate).toLocaleDateString('es-ES')}</li>
          ...
          <div className="bg-white rounded-lg p-8 border border-gray-200 text-center">
            ...
            <div className="bg-pink-50 border border-pink-200 rounded-lg p-6 mb-6 text-left">
              ...
              <div className="space-y-2 text-gray-700">
                <p><strong>Confirmación:</strong> {confirmationData.id}</p>
                <p><strong>Servicio:</strong> {confirmationData.service.name}</p>
                <p><strong>Fecha:</strong> {parseLocalDateString(confirmationData.appointment_date).toLocaleDateString('es-ES', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</p>
                <p><strong>Hora:</strong> {confirmationData.appointment_time}</p>
                <p><strong>Cliente:</strong> {confirmationData.client_name}</p>
                <p><strong>Contacto:</strong> {confirmationData.client_phone}</p>
              </div>
            </div>

            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <p className="text-sm text-gray-700">
                Te enviaremos un correo de confirmación a <strong>{confirmationData.client_email}</strong>
              </p>
            </div>

            <p className="text-gray-600 mb-6">
              Si necesitas cancelar o reprogramar, contáctanos por WhatsApp: <a href="https://wa.me/+18293388282" target="_blank" rel="noopener noreferrer" className="text-pink-600 font-semibold">+1 829 338 8282</a>
            </p>
